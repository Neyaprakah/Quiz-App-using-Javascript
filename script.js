...
function option12(){
    document.getElementById("opt12").style="background-color: green;color: white; border: 1px solid green;";
    document.getElementById("ans12").style="background-color: green; color: white; border: 1px solid green;";
}
function option13(){
...
function option23(){
    document.getElementById("opt23").style="background-color: green;color: white;border: 1px solid green;";
    document.getElementById("ans23").style="background-color: green; color: white;border: 1px solid green;";
}
function option24(){
...
function option32(){
    document.getElementById("opt32").style="background-color: green;color: white;border: 1px solid green;";
    document.getElementById("ans32").style="background-color: green; color: white;border: 1px solid green;";
}
function option33(){
...
function option42(){
    document.getElementById("opt42").style="background-color: green;color: white;border: 1px solid green;";
    document.getElementById("ans42").style="background-color: green; color: white;border: 1px solid green;";
}
function option43(){
...
function option54(){
    document.getElementById("opt54").style="background-color: green;color: white;border: 1px solid green;";
    document.getElementById("ans54").style="background-color: green; color: white;border: 1px solid green;";
}